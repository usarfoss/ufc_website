export const GitGudSVG = () => (
  ...
  >
    ...
    <rect width="100%" height="100%" fill="url(#gitGradient)" />
    <rect width="100%" height="100%" fill="url(#gridPattern)" />
    
    {/* Terminal windows */}
    <g transform="translate(50, 30)">
      <rect x="0" y="0" width="120" height="80" fill="url(#terminalGradient)" rx="8" stroke="#22c55e" strokeWidth="2" />
      <g fill="#22c55e">
    ...
    <g transform="translate(200, 150)">
      ...
      <circle cx="-60" cy="-15" r="10" fill="url(#glowGradient)" />
      <circle cx="-20" cy="-5" r="12" fill="url(#glowGradient)" />
      <circle cx="20" cy="5" r="10" fill="url(#glowGradient)" />
      <circle cx="60" cy="-10" r="8" fill="url(#glowGradient)" />
    ...
    <g transform="translate(20, 150)">
      <rect x="0" y="0" width="100" height="120" fill="url(#terminalGradient)" rx="6" stroke="#22c55e" strokeWidth="1" />
    ...
    <g fill="url(#codeGradient)" opacity="0.8">
      <g transform="translate(80, 60)">
        <rect x="-8" y="-8" width="16" height="16" fill="url(#terminalGradient)" rx="3" />
        <text x="0" y="2" fontSize="10" fontFamily="monospace" textAnchor="middle" fill="#22c55e">&lt;/&gt;</text>
      </g>
      <g transform="translate(320, 80)">
        <rect x="-12" y="-6" width="24" height="12" fill="url(#terminalGradient)" rx="2" />
        <text x="0" y="2" fontSize="8" fontFamily="monospace" textAnchor="middle" fill="#22c55e">git</text>
      </g>
      <g transform="translate(60, 240)">
        <rect x="-15" y="-5" width="30" height="10" fill="url(#terminalGradient)" rx="2" />
        <text x="0" y="2" fontSize="7" fontFamily="monospace" textAnchor="middle" fill="#22c55e">commit</text>
      </g>
      <g transform="translate(320, 220)">
        <rect x="-10" y="-4" width="20" height="8" fill="url(#terminalGradient)" rx="2" />
