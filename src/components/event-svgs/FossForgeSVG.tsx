...
export const FossForgeSVG = () => {
  ...
  const forgeGradientId = `${idPrefix}-forgeGradient`;
  const fireGradientId = `${idPrefix}-fireGradient`;
  const metalGradientId = `${idPrefix}-metalGradient`;
  const glowGradientId = `${idPrefix}-glowGradient`;
  const circuitPatternId = `${idPrefix}-circuitPattern`;
  ...
  return (
    ...
    >
      ...
      <defs>
        <linearGradient id={forgeGradientId} x1="0%" y1="0%" x2="100%" y2="100%">
        ...
        <pattern id={circuitPatternId} x="0" y="0" width="40" height="40" patternUnits="userSpaceOnUse">
      ...
      <rect width="100%" height="100%" fill={`url(#${forgeGradientId})`} />
      ...
      <g transform="translate(200, 150)">
        ...
        <rect x="-50" y="30" width="100" height="25" fill={`url(#${metalGradientId})`} rx="8" />
        <rect x="-45" y="25" width="90" height="30" fill={`url(#${metalGradientId})`} rx="6" />
        <rect x="-40" y="20" width="80" height="35" fill={`url(#${metalGradientId})`} rx="4" />
        
        {/* Anvil with detailed structure */}
        <rect x="-35" y="0" width="70" height="25" fill={`url(#${metalGradientId})`} rx="3" />
        <rect x="-30" y="-5" width="60" height="30" fill={`url(#${metalGradientId})`} rx="2" />
        
        {/* Forge flames */}
        <g fill={`url(#${fireGradientId})`} opacity="0.9">
        ...
        <g transform="rotate(-25)">
          <rect x="25" y="-8" width="50" height="12" fill={`url(#${metalGradientId})`} rx="3" />
          <rect x="70" y="-12" width="20" height="20" fill={`url(#${metalGradientId})`} rx="4" />
        ...
        {/* Spark trails */}
        <g stroke={`url(#${fireGradientId})`} strokeWidth="1" fill="none" opacity="0.6">
      ...
      <g transform="translate(80, 80)">
        ...
        <rect x="-10" y="0" width="20" height="25" fill={`url(#${fireGradientId})`} rx="3" />
        <rect x="-15" y="25" width="30" height="10" fill={`url(#${fireGradientId})`} rx="2" />
        <circle cx="0" y="-8" r="8" fill={`url(#${fireGradientId})`} />
      ...
      <g transform="translate(320, 100)">
        <rect x="0" y="0" width="70" height="100" fill={`url(#${metalGradientId})`} rx="8" stroke="#3b82f6" strokeWidth="2" />
      ...
      <g transform="translate(50, 200)">
        <rect x="0" y="0" width="80" height="60" fill={`url(#${metalGradientId})`} rx="6" stroke="#3b82f6" strokeWidth="1" />
        <text x="40" y="15" fontSize="8" fill="#ffffff" textAnchor="middle" fontWeight="bold">STAGES</text>
        
        {/* Stage indicators */}
        <g fill={`url(#${fireGradientId})`} opacity="0.8">
      ...
      <g fill={`url(#${fireGradientId})`} opacity="0.8">
        <g transform="translate(50, 200)">
          <rect x="-12" y="-6" width="24" height="12" fill={`url(#${metalGradientId})`} rx="3" stroke="#3b82f6" strokeWidth="1" />
          <text x="0" y="2" fontSize="8" fontFamily="monospace" textAnchor="middle" fill="#ffffff">FOSS</text>
        </g>
        <g transform="translate(300, 180)">
          <rect x="-15" y="-6" width="30" height="12" fill={`url(#${metalGradientId})`} rx="3" stroke="#3b82f6" strokeWidth="1" />
          <text x="0" y="2" fontSize="8" fontFamily="monospace" textAnchor="middle" fill="#ffffff">FORGE</text>
        </g>
        <g transform="translate(150, 50)">
          <rect x="-10" y="-5" width="20" height="10" fill={`url(#${metalGradientId})`} rx="2" stroke="#3b82f6" strokeWidth="1" />
      ...
      <g fill={`url(#${fireGradientId})`} opacity="0.6">
      ...
      <g stroke={`url(#${fireGradientId})`} strokeWidth="2" fill="none" opacity="0.7">
      ...
      <g stroke="#3b82f6" strokeWidth="2" fill="none" opacity="0.6">
        ...
        <path d="M100 250 Q200 220 300 250" markerEnd={`url(#${arrowheadId})`} />
      </g>
      ...
      <g transform="translate(200, 50)">
        <circle cx="0" cy="0" r="25" fill={`url(#${metalGradientId})`} stroke="#3b82f6" strokeWidth="2" />
        <circle cx="0" cy="0" r="20" fill={`url(#${fireGradientId})`} opacity="0.3" />
