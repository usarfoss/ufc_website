...
export const communityProjects: CommunityProject[] = [
  buildProject({
    ...
    repoUrl: "https://github.com/ManandeepSingh1196/NESt",
  ...
  buildProject({
    ...
    repoUrl: "https://github.com/Aayushkat/Snake_Game",
    creator: "Aayush Kat",
  ...
  buildProject({
    ...
    repoUrl: "https://github.com/mystic-06/quik-type",
  ...
  buildProject({
    ...
    repoUrl: "https://github.com/shashank-bingading/Connect_Four",
    creator: "Shashank",
  ...
  buildProject({
    ...
    repoUrl: "https://github.com/BhavyaB19/Collaborative-WhiteBoard",
    creator: "Bhavya",
    color: "blue",
  }),
  buildProject({
    ...
    repoUrl: "https://github.com/Ananya-jainn/cutesyroom",
    creator: "Ananya Jain",
  ...
  buildProject({
    ...
    repoUrl: "https://github.com/mridulxjain/Whizper",
    creator: "Mridul Jain",
  ...
  buildProject({
    ...
    repoUrl: "https://github.com/moksh-m9u/Market-ov",
    creator: "Moksh",
  ...
  buildProject({
    ...
    repoUrl: "https://github.com/ArunNegi112/Campus-agent",
    creator: "Arun Negi",
  ...
  buildProject({
    ...
    tech: ["C++"],
    github: "https://github.com/manandeepsingh1196",
    repoUrl: "https://github.com/ManandeepSingh1196/Black-Scholes-Model",
    creator: "Manandeep Singh",
    color: "green",
  }),
  buildProject({
    ...
    repoUrl: "https://github.com/Yashcodes07/Github-Integrated-Dashboard",
    creator: "Yash",
  ...
  buildProject({
    ...
    repoUrl: "https://github.com/CodeByJatin/network_sniffer",
    creator: "Jatin",
  ...
  buildProject({
    ...
    repoUrl: "https://github.com/abhi-rajput-KRP/PollStream",
    creator: "Abhi Rajput",
  ...
  buildProject({
    ...
    repoUrl: "https://github.com/harshitthek/Customizable-Browser-Startpage",
    creator: "Harshit",
    color: "blue",
  }),
  buildProject({
    ...
    repoUrl: "https://github.com/ananya0-0/Hand-Gesture-Recognition-",
    creator: "Ananya",
  ...
  buildProject({
    ...
    repoUrl: "https://github.com/vaibhavi-nope-source/Stegosaurus",
    creator: "Vaibhavi",
  ...
  buildProject({
    ...
    repoUrl: "https://github.com/Ojaswini-Fauzdar/Fake-news-detector",
    creator: "Ojaswini",
  ...
  buildProject({
    ...
    repoUrl: "https://github.com/Manu-2717/meme-generator",
    creator: "Meyank",
  ...
  buildProject({
    ...
    repoUrl: "https://github.com/DarshitaBhagat/AIWorkoutTracker",
    creator: "Darshita Bhagat",
    color: "purple",
  }),
  buildProject({
    id: 20,
    ...
    repoUrl: "https://github.com/piyush588/Park-Conscious",
    creator: "Sujal Maity",
  ...
  buildProject({
    ...
    repoUrl: "https://github.com/SaikiaMan/VisoraMVP",
    creator: "Manob",
  ...
  buildProject({
    ...
    github: "https://github.com/saikiaman",
    repoUrl: "https://github.com/SaikiaMan/LaunchPad",
    creator: "Manob",
  ...
  buildProject({
    ...
    repoUrl: "https://github.com/Bhuwan-007/Pokemon_Game",
    creator: "Bhuwan",
  ...
  buildProject({
    ...
    github: "https://github.com/bhuwan-007",
    repoUrl: "https://github.com/Bhuwan-007/My-metro-mates",
    creator: "Bhuwan",
  ...
  buildProject({
    ...
    repoUrl: "https://github.com/shifali0156-wq/RAG-ChatBot",
    creator: "Shifali",
  ...
  buildProject({
    ...
    repoUrl: "https://github.com/sidd190/stride",
    creator: "Sidd",
  ...
  buildProject({
    ...
    repoUrl: "https://github.com/Pranshu640/UFC-Project-Tracker",
    creator: "Pranshu",
